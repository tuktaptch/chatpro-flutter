...
class CTextField extends StatefulWidget {
  ...
  /// Custom enable border color.
  ///
  /// If null, it will use the default value.
  final Color? borderColor;

  /// Custom enable border width.
  ///
  /// If null, it will use the default value.
  final double? borderWidth;

  /// The duration for the debounce.
        ...
        if (widget.labelText != null)
          Row(
            children: [
              ...
              if (widget.isRequired) const SizedBox(width: 4.0),
            ...
            Theme(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  errorStyle: CTypography.caption2.copyWith(height: 0),
                  helperStyle: CTypography.caption2.copyWith(height: 0),
                  hintText: widget.placeHolderText,
                  hintStyle:
                      widget.placeHolderStyle ??
                      CTypography.body3.copyWith(color: CColors.darkGray),
                  isDense: true,
                  ...
                  enabledBorder: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(
                      ...
                      color: widget.borderColor ?? CColors.paleBlue,
                    ),
                  ),
                  ...
                  disabledBorder: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(
                      width: widget.borderWidth ?? 1,
                      color: widget.borderColor ?? CColors.hotPink,
                    ),
                  ),
                  prefixIcon: widget.prefixIcon,
                  suffixIcon: widget.suffixIcon,
                  suffixIconColor: CColors.veryLightBlue,
                  counterText: '',
                ),
